          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>EDIT <small>DAFTAR KARYAWAN</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <form class="form-horizontal form-label-left" action ='<?=site_url('Admin/uploading/updated/'.$kary['nip'])?>' method="POST">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="user" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" data-validate-words="2" name="user" type="text" value='<?=$kary['username']?>'>
                        </div>
                      </div>
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nip" name="nip" required="required" class="form-control col-md-7 col-xs-12" value='<?=$kary['nip']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama" name="nama" required="required" class="form-control col-md-7 col-xs-12" value='<?=$kary['nama']?>'>
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="alamat" name="alamat" required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" value='<?=$kary['alamat']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="date" id="tanggal" name="tanggal" required="required" class="form-control col-md-7 col-xs-12" value='<?=$kary['tgl_lhr']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
                        <label for="tempat" class="control-label col-md-3">Tempat Lahir</label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="tempat" type="text" name="tempat" class="form-control col-md-7 col-xs-12" required="required" value='<?=$kary['tempat_lhr']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="email" type="email" name="email" class="form-control col-md-7 col-xs-12" required="required" value='<?=$kary['email']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel" id="phone" name="phone" required="required" data-validate-length-range="8,20" class="form-control col-md-7 col-xs-12" value='<?=$kary['telp']?>'>
                        </div>
                      </div>
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <select id="jabatan" required="required" name="jabatan" class="form-control col-md-7 col-xs-12">
					  ...
					  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="file" id="photo" required="required" name="photo" class="form-control col-md-7 col-xs-12" value='<?=$kary['photo']?>'></text>
                        </div>
                      </div>
                      <div class="ln_solid"></div>
                      <div class="form-group">
                        <div class="col-md-6 col-md-offset-3">
                          <button type="submit" class="btn btn-primary"><a href ="<?php echo base_url('index.php/Admin/karyawan');?>">Cancel</a></button>
                          <button id="send" type="submit" class="btn btn-success" value="upload">Submit</button>
                        </div>
                      </div>
                    </form>
                  </div>
