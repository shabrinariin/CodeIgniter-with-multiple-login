...
<html lang="en">
  <head>
    ...
    <!-- JQVMap -->
    <link href="<?php echo base_url();?>asset/master/vendors/jqvmap/dist/jqvmap.min.css" rel="stylesheet"/>
  ...
  <body class="nav-md">
    ...
    <!-- Chart.js -->
    <script src="<?php echo base_url();?>asset/master/vendors/Chart.js/dist/Chart.min.js"></script>
    <!-- gauge.js -->
    <script src="<?php echo base_url();?>asset/master/vendors/gauge.js/dist/gauge.min.js"></script>
    <!-- bootstrap-progressbar -->
    ...
    <!-- Skycons -->
    <script src="<?php echo base_url();?>asset/master/vendors/skycons/skycons.js"></script>
    <!-- Flot -->
    <script src="<?php echo base_url();?>asset/master/vendors/Flot/jquery.flot.js"></script>
    <script src=".<?php echo base_url();?>asset/master/vendors/Flot/jquery.flot.pie.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/Flot/jquery.flot.time.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/Flot/jquery.flot.stack.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/Flot/jquery.flot.resize.js"></script>
    <!-- Flot plugins -->
    <script src="<?php echo base_url();?>asset/master/vendors/flot.orderbars/js/jquery.flot.orderBars.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/flot-spline/js/jquery.flot.spline.min.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/flot.curvedlines/curvedLines.js"></script>
    <!-- DateJS -->
    <script src="<?php echo base_url();?>asset/master/vendors/DateJS/build/date.js"></script>
    <!-- JQVMap -->
    <script src="<?php echo base_url();?>asset/master/vendors/jqvmap/dist/jquery.vmap.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/jqvmap/dist/maps/jquery.vmap.world.js"></script>
    <script src="<?php echo base_url();?>asset/master/vendors/jqvmap/examples/js/jquery.vmap.sampledata.js"></script>
