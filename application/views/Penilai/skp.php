                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<form method="post" action="<?php echo base_url();?>index.php/Penilai/skp">
							<div class="col-lg-3">
                      ...
                      <tbody>
						...
						<tr> <td><?= $data->bulan ?> - <?= $data->tahun ?></td>
							 ...
							 <td><?=$data->nama?></td>
							 <td><?=$data->judul?></td>
							 <td><a href="<?php echo base_url();?>index.php/Penilai/skp/terima/<?=$data->id ?>" title="accept" class=""><span class="glyphicon glyphicon-ok"></span></a>
								<a href="<?php echo base_url();?>index.php/Penilai/skp/tolak/<?=$data->id ?>" title="decline"><span class="glyphicon glyphicon-remove"></span></a>
							 </td>
						</tr>
						<?php endforeach;?>
                      </tbody>
