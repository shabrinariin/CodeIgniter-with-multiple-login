                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<form method="post" action="<?php echo base_url();?>index.php/Penilai/skp/diterima">
							<div class="col-lg-3">
                      ...
                      <tbody>
						...
						<tr> <td><?= $data->bulan ?> - <?= $data->tahun ?></td>
							 <td><?=$data->judul?></td>
							 <td><?=$data->penilai?></td>
							 <td><a href="<?php echo base_url();?>index.php/Penilai/skp/detail/<?=$data->nip ?>/<?=$data->bulan ?>/<?=$data->tahun ?>"><i class="fa fa-weibo" title="Lihat Detail"></i><a>
								 <a href="<?php echo base_url();?>index.php/Penilai/skp/getnilai/<?=$data->nip ?>/<?=$data->bulan ?>/<?=$data->tahun ?>"><i class="fa fa-edit" title="Beri nilai"></i><a>
							 </td>
						</tr>
						<?php endforeach;?>
                      </tbody>
