            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
						...
						<form method="post" action="<?php echo base_url();?>index.php/Kar/skp/simpanedit">
							<?php foreach($dit as $dt) :?>
								<div class="col-md-2 col-sm-9 col-xs-12">
								<label>Id :</label>
								</div>
								<div class="col-md-2 col-sm-9 col-xs-12">
                                <input class="form-control" name="ide" id="ide" value="<?=$dt->id ?>" disabled/>
								</div>
								<br><br>
								<div class="col-md-2 col-sm-9 col-xs-12">
								Bulan :
								...
								<select id="bln" required="required" name="bln" class="form-control col-md-5 col-xs-12" >
									...
									<option value="<?=$data->id_bulan ?>" <?=$dt->bulan == $data->id_bulan ?"selected":"";?>><?=$data->nama_bulan ?></option>
									<?php endforeach; ?>
								</select>
								</div><br><br>
								<div class="col-md-2 col-sm-9 col-xs-12">
								...
								<select id="thn" required="required" name="thn" class="form-control col-md-5 col-xs-12" >
									...
									<option value="<?=$data->id_tahun ?>" <?=$dt->tahun == $data->id_tahun ?"selected":"";?>><?=$data->tahun ?></option>
									<?php endforeach; ?>
								</select>
								</div><br><br>
								<div class="col-md-2 col-sm-9 col-xs-12">
                                ...
                                <input class="form-control" name="usul" id="usul" type="text" value="<?=$dt->judul ?>"">
								</div>
								<div class="col-md-2 col-sm-9 col-xs-12">
