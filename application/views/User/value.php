				...
				<center><img src="<?=base_url();?>asset/upload/<?=$this->session->userdata('photo')?>" width="75" height="75" class="img-circle profile_img"></center>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-edit fa-fw"></i> Nilai</a>
                        </li>
                    </ul>
                </div>
                <!-- /.sidebar-collapse -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<form method="post" action="<?php echo base_url();?>index.php/Kar/nilai">
							<div class="col-lg-3">
                        ...
                        <tr>
                          ...
                          <th rowspan="2">Sasaran Kerja</th>
						  <th colspan="6"><center>Sikap</center></th>
                      ...
                      <tbody>
						...
						<tr> <td><?= $data->bulan ?> - <?= $data->tahun ?></td>
							...
							<td>kerjasama</td>
							<td>kepemimpinan</td>
							<td><a href="<?php echo base_url().'index.php/Kar/nilai/printin/'.$data->id_nilai;?>" title="print"><i class="fa fa-print"></i></a></td>
						</tr>
						</tr>
						<?php endforeach;?>
                      </tbody>
