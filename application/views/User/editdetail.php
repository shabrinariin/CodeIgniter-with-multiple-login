                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<form method="post" action="<?php echo base_url();?>index.php/Kar/skp/simpaneditdetail/">
								...
								<select id="tanggal" required="required" name="tanggal" class="form-control col-md-5 col-xs-12" >
									...
									<option value="<?=$data->id_tgl ?>" <?=$sk->tanggal == $data->id_tgl ?"selected":"";?>><?=$data->no ?></option>
									<?php endforeach; ?>
								</select>
								</div>
								<div class="col-md-2 col-sm-9 col-xs-12">
                                ...
                                <input class="form-control" name="kg" id="kg" type="textarea" value="<?=$sk->Kegiatan ?>">
								</div>
								<div class="col-md-2 col-sm-9 col-xs-12">
