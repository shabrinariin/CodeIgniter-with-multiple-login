                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="col-lg-3">
							<a href="<?php echo base_url();?>index.php/Kar/skp/tambahusul"><button type="button" class="btn btn-default" title="add usulan"><i class="fa fa-plus"></i> Tambah Usulan</button></a>
							</div>
							<br><br>
							
                            <div class="dataTable_wrapper">
							<div class="col-lg-2">Pilih Tahun :</div>
							<form method="post" action="<?php echo base_url();?>index.php/Kar/skp">
							<div class="col-lg-3">
                      ...
                      <tbody>
						...
						<tr> <td><?= $data->bulan ?> - <?= $data->tahun ?></td>
							 <td><?=$data->judul?></td>
							  <td><a href="<?php echo base_url().'index.php/Kar/skp/edit/'.$data->id;?>" title="edit"><i class="fa fa-edit"></i></a> 
								 <a href="<?php echo base_url().'index.php/Kar/skp/deleteusl/'.$data->id;?>" title="delete"><i class="fa fa-eraser"></i></a></td>
						</tr>
						<?php endforeach;?>
                      </tbody>
                                </table>
