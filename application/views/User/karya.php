				...
				<center><img src="<?=base_url();?>asset/upload/<?=$this->session->userdata('photo')?>" width="75" height="75" class="img-circle profile_img"></center>
                    ...
                    <ul class="nav" id="side-menu">
                       <li>
						...
						<li>
                            <a href="#"><i class="fa fa-sitemap fa-fw"></i> Daftar Karyawan</a>
						</li>
                        <li>
                    ...
                    <div class="panel panel-default">
                      ...
                      <tbody>
						...
						<tr>
							 ...
							 <td><a href="<?php echo base_url().'index.php/Kar/lihatkaryawan/detail/'.$data->nip;?>" title="view"><i class="fa fa-eye"></i></a> 
						</tr>
						<?php endforeach;?>
                      </tbody>
                                </table>
