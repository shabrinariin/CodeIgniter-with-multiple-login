                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="col-lg-1">
							<a href="<?php echo base_url();?>index.php/Kar/skp/diterima"><button type="button" class="btn btn-default" title="back"><i class="fa fa-arrow-left"></i></button></a>
							</div>
							<div class="col-lg-3">
							<?php foreach ($tgl as $data):?> 
							 <a href="<?php echo base_url();?>index.php/Kar/skp/tambahdetail/<?=$data->bulan ?>/<?=$data->tahun ?>"><button type="button" class="btn btn-default"><i class="fa fa-search"></i>Tambah Detail</button>
							 </a>
							<!--<?php endforeach;?> -->
							 </div>  
							</div>
                      ...
                      <tbody>
						<!--<?php foreach ($tgl as $data):?> -->
						<tr> <td><?= $data->tanggal ?> - <?= $data->bulan ?> - <?= $data->tahun ?></td>
							 <td><?=$data->Kegiatan?></td>
							 <td> <a href="<?php echo base_url();?>index.php/Kar/skp/editdetail/<?=$data->tanggal ?>/<?=$data->bulan ?>/<?=$data->tahun ?>" title="edit"><i class="fa fa-edit"></i></a> 
								 <a href="<?php echo base_url();?>index.php/Kar/skp/deletedetail/<?=$data->tanggal ?>/<?=$data->bulan ?>/<?=$data->tahun ?>" title="delete"><i class="fa fa-eraser"></i></a> </td>
						</tr>
						<?php endforeach;?>
                      </tbody>
                      </table>
